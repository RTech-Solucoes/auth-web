...
const FEATURES = [
  {
    ...
    desc: "Processo de recuperação de senha com validação por email e token temporário.",
  },
  {
    icon: <Lock size={14} color="#a6c1ed" />,
    title: "Acesso protegido",
    desc: "Link de recuperação expira em 30 minutos para garantir a segurança da conta.",
  },
  {
    icon: <Headphones size={14} color="#a6c1ed" />,
    title: "Suporte disponível",
    desc: "Entre em contato com o administrador caso tenha dificuldades no acesso.",
  },
];
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, transparent 35%, rgba(2,6,16,0.85) 80%, rgba(2,6,16,0.95) 100%)",
            pointerEvents: "none",
            zIndex: 3,
          }}
        />
          ...
          {!emailSent ? (
            <>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <div
                  style={{ fontWeight: 700, fontSize: "clamp(22px, 4vw, 32px)", color: "#ffffff" }}
                >
                  Esqueceu a senha?
                </div>
                <div
                ...
                >
                  Informe seu email cadastrado e enviaremos instruções para recuperação.
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: "rgba(96,165,250,0.9)", lineHeight: 1.5 }}>
                    O link de recuperação expira em 30 minutos. Verifique sua caixa de entrada e
                    spam.
                  </div>
                </div>
              </div>
              ...
              <div
                onClick={!isLoading && isEmailValid ? handleSendEmail : undefined}
                ...
                style={{
                  ...
                  textAlign: "center",
                  transform:
                    isHovered && !isLoading && isEmailValid ? "translateY(-2px)" : "translateY(0)",
            ...
            <>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                >
                  ...
                  <strong style={{ color: "#a6c1ed" }}>{email}</strong>
                </div>
              </div>
              ...
              >
                <span style={{ fontWeight: 700, fontSize: 15, color: "rgba(255,255,255,0.8)" }}>
                  Voltar para o login
                </span>
              </div>
            </>
